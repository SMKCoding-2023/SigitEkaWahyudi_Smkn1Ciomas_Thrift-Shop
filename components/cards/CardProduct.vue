...
<template>
    <section class="bg-white shadow-xl rounded-xl overflow-hidden">
        ...
        <NuxtLink :to="`/product/${oneProduct.id}`" ><h3 class="text-lg fontbold mb-4 text-limit limit-2">{{ oneProduct.name }}</h3></NuxtLink>
    ...
    rounded-full flex justify-center items-center hover:bg-blue-600 hover:textwhite transition duration-300`" @click="addCart">
